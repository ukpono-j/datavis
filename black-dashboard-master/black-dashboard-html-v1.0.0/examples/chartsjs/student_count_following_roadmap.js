const display = async() => {
  let data = await fetch('./student_count_following_roadmap_subject_histogram.json')
...
let chartEle1 = document.getElementById('student_count_following_roadmap_subject_histogram').getContext("2d");
