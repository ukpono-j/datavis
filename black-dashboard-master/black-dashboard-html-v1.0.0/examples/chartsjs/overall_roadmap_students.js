const display = async() => {
  let data = await fetch('./overall_roadmap_student_histogram.json')
  data = await data.json()
  data = data.data.slice(2, 200)
...
let chartEle1 = document.getElementById('overall_roadmap_student_histogram').getContext("2d");
